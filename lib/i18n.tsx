...
const translations = {
  ...
  "timeline.2025.description": "Reached 600+ properties sold, with AED 1.9B+ in transactions. Recognized as a leading Real Estate investment strategist in Dubai & the UK.",
...
"property.status.Sold" : "Sold",
  ...
  "contact.budget.placeholder": "e.g., AED 1M - AED 2M",
  ...
  "about.section1.text2": "As Investment Director at Select Property, she has successfully closed over 600 Real Estate transactions, exceeding AED 1.9 billion in value.",
  ...
  "about.achievements.1.description": "Successfully closed transactions worth over AED 1.9 billion",
  ...
  "about.achievements.4.description": "Fluent in English, Arabic, and Russian",
    ...
    "testimonials.join.title": "Join 600+ Satisfied Investors",
  ...
  "properties.status.sold": "Sold",
    ...
    // Testimonials
    "testimonials.join": "Join 600+ Satisfied Investors",
  ...
  "timeline.2025.description": " حققت بيع أكثر من 600 عقاراً بقيمة إجمالية تتجاوز 1.9 مليار درهم إماراتي، لتُرسّخ مكانتها كأحد أبرز استراتيجيي الاستثمار العقاري في دبي والمملكة المتحدة.",
  ...
  "about.section1.text2": "كمديرة للاستثمار في Select Property، أتمّت أكثر من 600 صفقة عقارية بقيمة تتجاوز 1.9 مليار درهم إماراتي، مؤكدة مكانتها كإحدى أبرز الخبراء في عالم الاستثمار العقاري.",
  ...
  "about.achievements.1.description": "أتمت بنجاح معاملات تزيد قيمتها عن 1.9 مليار درهم إماراتي",
  "about.achievements.2.number": "30+",
...
"property.status.Sold" : "مباع",
  ...
  "blog.read.more": "اقرأ المزيد",
    ...
    "testimonials.join.title": "انضم إلى 600+ مستثمر راضٍ",
    ...
    "contact.budget.placeholder": "مثلاً، 1M - 2M درهم",
    ...
    "testimonials.join.alt": "انضم إلى 600+ مستثمر ناجح",
...
"contact.success.new.evaluation": "Отправить новое сообщение",
  ...
  "timeline.2025.description": "Виктория лично завершила более 600 сделок с недвижимостью на общую сумму свыше 1,7 млрд дирхамов ОАЭ, укрепив свою позицию как одного из ведущих стратегов в сфере инвестиций в недвижимость в Дубае и Великобритании",
  ...
  "blog.description.4": "Ознакомьтесь с новейшими идеями и стратегиями для повышения доходности",
   ...
   "about.section1.text2": "Как директор по инвестициям в Select Property, она заключила более 600 сделок на сумму свыше 1,7 млрд дирхамов ОАЭ, что закрепило её репутацию одного из ведущих экспертов в сфере инвестиций в недвижимость",
...
,
    ...
    "testimonials.join.title": "Присоединяйтесь к 600+ довольным инвесторам",
    "testimonials.join.subtitle":
  ...
  "evaluation.success.new.evaluation": "Отправить новую оценку",
    ...
    "contact.budget.placeholder": "например, 1M - 2M AED",
