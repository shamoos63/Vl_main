...
const faqData = {
  ...
  ar: [
    {
      ...
      answer:
        "بالطبع. يمكن لغير المقيمين امتلاك العقارات بالكامل في المناطق المخصصة للملكية الحرة في جميع أنحاء دبي. إنها عملية مبسطة ترحب بالمستثمرين العالميين دون الحاجة إلى الإقامةنعم، في دبي مناطق مخصّصة للتملّك الحر تتيح للأجانب امتلاك العقار بشكل كامل، بآلية واضحة وبسيطة تجعل الاستثمار متاحاً وجاذباً لرأس المال العالمي… دون الحاجة إلى إقامة مسبقة.",
    },
    {
  ...
  <>
    ...
    العقار الجاهز:  يوفّر دخلاً فورياً من الإيجار.<br />
    العقار على الخريطة: عادةً يكون أقل كلفة، بخطط دفع مرنة، مع إمكانية نمو أعلى لرأس المال.
  </>
)
    },
    {
    ...
    answer: (
  <>
    يحسب وجهة نظري، المناطق الأهم هي: مرسى دبي، وسط المدينة، نخلة جميرا، قرية جميرا الدائرية، الخليج التجاري، ومدينة دبي الملاحية.
